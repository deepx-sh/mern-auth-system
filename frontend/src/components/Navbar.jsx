    ...
    <header className='sticky top-0 z-30 w-full border-b border-white/10 bg-[#050505]/90 backdrop-blur'>
      <div className='mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
        <div className='flex h-14 items-center justify-between'>
          ...
          <div className='hidden sm:flex items-center gap-3'>
              <button type='button' className='text-sm text-[#C9C9C9] border hover:text-[#F8F8F8] px-3 py-1.5 rounded-full transition-colors cursor-pointer'>Login</button>
              <button type='button' className='text-sm font-medium px-4 py-1.5 rounded-full bg-[#FF6B00] text-[#F8F8F8] hover:bg-[#E65A00] transition-colors shadow-sm cursor-pointer'>Sign up</button>
          </div>
      ...
      <div className={`sm:hidden border-t  border-white/10 bg-[#050505]/95 transition-all duration-200 ease-out ${mobileOpen? "max-h-32 opacity-100": "max-h-0 opacity-0"} overflow-hidden`}>
        <div className='mx-auto max-w-6xl px-4 py-3 space-y2'>
          <button type='button' className='w-full text-left text-sm text-[#C9C9C9] hover:text-[#F8F8F8] px-3 py-2 rounded-md hover:bg-[#111111] transition-colors'>Login</button>
          
          <button type='button' className='w-full text-sm mt-2 font-medium px-3 py-2 rounded-full bg-[#FF6B00] text-[#F8F8F8] hover:bg-[#E65A00] transition-colors shadow-sm'>Sign up</button>
            </div>
      </div>
    </header>
  )
